...
relation: {parent doc} → modules1/{moduleName}/{path}
...
- `relation` — The documentation chain that leads here. Always start from the nearest `Enforce` ancestor. Example: `RULES.md → modules1/{moduleName}/`.
...
- Place each module's documentation inside `Docs/modules1/{moduleName}/`.
...
- Directory: `Docs/modules1/{moduleName}/` (PascalCase or kebab-case matching the source module).
...
- Example full chain: `README.md → index.md → RULES.md → modules1/profile/`.
