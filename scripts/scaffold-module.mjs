...
const ROUTES_FILE = join(SRC, "core", "routes.tsx");
...
function createModule(name) {
  ...
  if (!routesContent.includes(importLine.trim())) {
    ...
    // Insert route entry inside the children array, before its closing ],
    const childrenClosePattern = /\n    \],\n  \},\n\];/;
    const final = updated.replace(childrenClosePattern, `\n${routeEntry}    ],\n  },\n];`);
