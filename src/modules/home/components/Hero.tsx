...
function Hero() {
  return (
    <section className="flex w-full flex-col items-center bg-gray-50 px-6 pt-24 pb-16 md:px-8 md:pt-28 md:pb-20">
      <div className="mt-[40px] flex max-w-[800px] flex-col items-center text-center">
        <h1 className="font-heading text-[32px] font-bold leading-tight text-gray-900 md:text-[48px]">
          {data.title}
        </h1>

        <p className="mt-4 font-heading text-[18px] font-semibold uppercase tracking-[0.3em] text-gray-500 md:text-[20px]">
          {data.subtitle}
        </p>
      </div>
